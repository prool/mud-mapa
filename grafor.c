...
printf("<!-- prool's mud mapa maker) - http://mud.kharkov.org http://mud.virtustan.net -->\n");
printf("<!-- https://github.com/prool/mud-mapa -->\n");
...
fprintf(stderr,"Mud-Mapa Startzone %i\n", STARTZONE);
...
printf("%s map. Generated by MudMapa by Prool %s. Zone=%i\n", MUDname, ptime(), STARTZONE);
//printf("x0=%i y0=%i z0=%i\n", x0, y0, z0);

printf("<a href=%i.wld_.html>One</a>\n", STARTZONE);
